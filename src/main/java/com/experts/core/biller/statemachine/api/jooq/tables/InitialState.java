...
public class InitialState extends TableImpl<InitialStateRecord> {
    ...
    private static final long serialVersionUID = 119434330;
    ...
    /**
     * The column <code>public.initial_state.version</code>.
     */
    public final TableField<InitialStateRecord, Integer> VERSION = createField("version", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
