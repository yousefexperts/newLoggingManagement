...
@Entity
@Table( name  = "bill_creation_history")
@Data
@XmlAccessorType
@XmlRootElement(name  = "billing_creation_history")
@SpaceClass
public class BillingCreationHistory extends AbstractEntity_ implements Serializable {
