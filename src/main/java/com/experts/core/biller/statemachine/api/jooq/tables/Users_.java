...
public class Users_ extends TableImpl<Users_Record> {
    ...
    private static final long serialVersionUID = 571580796;
    ...
    /**
     * The column <code>public.users_.lastmodifiedby</code>.
     */
    public final TableField<Users_Record, String> LASTMODIFIEDBY = createField("lastmodifiedby", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
    ...
    /**
     * The column <code>public.users_.password_token</code>.
     */
    public final TableField<Users_Record, String> PASSWORD_TOKEN = createField("password_token", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.users_.username_token</code>.
     */
    public final TableField<Users_Record, String> USERNAME_TOKEN = createField("username_token", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.users_.version</code>.
     */
    public final TableField<Users_Record, Integer> VERSION = createField("version", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
