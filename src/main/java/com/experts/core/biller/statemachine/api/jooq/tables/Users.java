...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 829960131;
     ...
     */
    public final TableField<UsersRecord, Boolean> EXPIRED = createField("expired", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.users.locked</code>.
     */
    public final TableField<UsersRecord, Boolean> LOCKED = createField("locked", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.UK_3G1J96G94XPK3LPXL2QBL985X, Indexes.USERS_PKEY);
    }
    ...
    public List<UniqueKey<UsersRecord>> getKeys() {
        return Arrays.<UniqueKey<UsersRecord>>asList(Keys.USERS_PKEY, Keys.UK_3G1J96G94XPK3LPXL2QBL985X);
    }
